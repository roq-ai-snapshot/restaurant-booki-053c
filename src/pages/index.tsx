  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Restaurant Booking Engine: Elevating your dining experience with seamless table reservations and efficient restaurant management in your hands."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Restaurant Booking Engine: Elevating your dining experience with seamless table reservations and efficient restaurant management in your hands.`}
            </Text>
            <Box
